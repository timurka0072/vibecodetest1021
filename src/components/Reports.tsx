...
export default function Reports({ ipAssignments, signatures, employees, onUpdateIP }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {showSuccess && (
        <div className="fixed top-20 right-6 z-50 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2">
          <CheckCircle size={20} />
      ...
      {reportType === 'free-ips' && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={handleExportFreeIPs}
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleExportByRoom}
                className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm flex items-center gap-2">
                <Download size={14} />Экспорт
              </button>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleExportByEmployee}
                className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm flex items-center gap-2">
                <Download size={14} />Экспорт
              </button>
            </div>
      ...
      {reportType === 'expiring-sigs' && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={handleExportExpiringSigs}
              className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm flex items-center gap-2">
              <Download size={14} />Экспорт
            </button>
          </div>
